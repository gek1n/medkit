...
/// Крок 4.4.4 плану: місток між draft-режимом форм створення (Крок 4.4.2/
/// 4.4.3, `onDraftCreated` в Add*Screen) і синхронізацією (Крок 4.4.1,
/// `FamilyPeerSyncService.proposeRecord`) — тут, а не в самих екранах форм,
/// щоб кожна з 5 форм лишалась зовсім не обізнаною про Сім'ю: вона просто
/// віддає типізований Companion, а решту (переклад у fields-мапу, пошук
/// sectionSyncUuid, надсилання) робить один спільний шлях.
const _uuid = Uuid();
...
Future<void> _submit(
  ...
  return FamilyPeerSyncService(ref.read(databaseProvider)).proposeRecord(
...
// FamilyPeerSyncService._insertRecord/_updateRecordIfUnchanged) ────────────
