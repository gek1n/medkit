...
class FamilyPeerSyncService {
  ...
  // медкартку".
  //
  // Реальний баг (10.08, скарга користувача — одноразове нагадування
  // "Тестове" ніколи не долітало до піра, хоча viewSchedule=true): doctor_
  // appointment/reminder_log/reminder_slot — це застаріла назва сутності з
  // часів, коли "запис до лікаря" був окремим типом усередині медкартки.
  // Після об'єднання в загальні "Нагадування" (тепер розділ Розкладу, не
  // Медкартки — сам план прямо називає "ліки, рутини, нагадування,
  // самопочуття" одним пакетом) цю прив'язку так і не оновили — нагадування
  // й далі ховались за прапорцем "Синхронізувати медкартку"/грантом
  // Медкартка, тож глядач із дозволом ЛИШЕ на Розклад (без Медкартки)
  // ніколи їх не отримував.
