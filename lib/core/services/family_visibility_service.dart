...
/// Полички свідомо відсутні тут — самі Полички ще не синхронізуються між
/// пристроями (Крок 5-6), тож перемикач для них поки що не мав би на що
/// впливати; додасться сюди тим самим способом, коли синхронізація буде
/// готова.
enum FamilySection { schedule, medcard }
