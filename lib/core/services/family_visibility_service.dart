...
/// ⚠️ Це лише зберігання вибору користувача — фактичне обмеження
/// (фільтрація сповіщень, блокування редагування/перегляду) в інших
/// екранах застосунку ще не підключене.
