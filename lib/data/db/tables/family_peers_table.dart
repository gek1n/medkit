...
class FamilyPeers extends Table {
  ...
  BoolColumn get introductionSent => boolean().withDefault(const Constant(true))();
  ...
  // стирався по TTL, теж мовчки). false — щойно приєднався, картку ще треба
  // (повторно) надіслати при кожному sync-раунді, доки не вийде;
