...
class MedIntake {
  ...
  const MedIntake({
    required this.id, required this.medicationId, required this.medicationName,
    required this.medicationDose, required this.medicationEmoji,
    required this.scheduledAt, required this.status, this.takenAt,
  });
  ...
  MedIntake copyWith({IntakeStatus? status, DateTime? takenAt}) => MedIntake(
    ...
    medicationDose: medicationDose, medicationEmoji: medicationEmoji,
    scheduledAt: scheduledAt, status: status ?? this.status, takenAt: takenAt ?? this.takenAt,
  );
}
