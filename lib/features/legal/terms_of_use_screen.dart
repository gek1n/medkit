            ...
            Expanded(
              child: ListView(
                ...
                children: [
                  ...
                  Text(
                    'MedKit © 2026. Ці Умови застосовуються разом з Політикою конфіденційності.',
...
final _sections = <LegalSection>[
  LegalSection(Icons.check_circle_outline_rounded, '1. Прийняття умов', [
    legalP(
      'Використовуючи застосунок MedKit, ви погоджуєтесь з цими Умовами '
  ...
  LegalSection(Icons.medical_services_outlined, '2. Медичне застереження', [
    legalCallout(
      'MedKit не є медичним пристроєм, не надає медичних консультацій і не '
  ...
  LegalSection(Icons.build_outlined, '3. Опис сервісу', [
    legalP(
      'MedKit — мобільний застосунок для планування прийому ліків, '
  ...
  LegalSection(Icons.credit_card_rounded, '4. Тарифні плани та оплата', [
    ...
    legalP(
      ...
      'Google Play — MedKit не обробляє й не зберігає дані вашої платіжної '
      'картки самостійно.',
    ),
    legalCallout(
      ...
      'MedKit ця можливість недоступна.',
  ...
  LegalSection(Icons.person_outline_rounded, '5. Ваші обов\'язки', [
    legalBullets([
      ...
      "Забезпечити безпеку доступу до свого пристрою (код блокування, "
          "біометрія) — MedKit не може захистити дані, якщо доступ до "
  ...
  LegalSection(Icons.copyright_rounded, '6. Інтелектуальна власність', [
    legalP(
      'Застосунок MedKit, його дизайн, логотип і код належать розробнику '
