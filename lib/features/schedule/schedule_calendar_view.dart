...
class ScheduleCalendarView extends ConsumerStatefulWidget {
  ...
  // Непорожній — календар читає дані з уже перекладеного кешу піра
  // (peerScheduleCalendarDayProvider), а не з локальної БД за memberId
  // (memberId тоді — лише синтетичний ідентифікатор для CalendarItem, не
  // реальний запис у Members).
