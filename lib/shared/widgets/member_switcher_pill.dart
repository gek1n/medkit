...
/// (Розклад, Медкартка).
///
/// Крок 4.3.3 плану: той самий пікер тепер показує і автономних членів
/// сім'ї (окремий пристрій) в тому самому списку — [peers]/[selectedPeer]/
/// [onSelectPeer] необов'язкові, щоб не чіпати виклики, де пірів ще не
/// підключено.
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            AvatarImage(index: displayAvatar, size: 20),
            const SizedBox(width: 6),
            Text(displayName, style: AppTextStyles.labelMd),
